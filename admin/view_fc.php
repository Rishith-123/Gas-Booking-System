...
if(isset($_SESSION['aid']))
{
	...
	$result=pg_query($conn,"select name from distributor_detail") or die(pg_error($conn));
	...
	$result=pg_query($conn,"select fc.cid,c.name,d.did,d.name,date,time,type,subject,description from feedback_complain fc
